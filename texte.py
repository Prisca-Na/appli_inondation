...
with col_map:
    ...
    if st.button("Calculer la probabilité d'inondation"):
        ...
        ax.text(
            0.01, 0.99,
            f"Niveau de confiance global: {cm:.3f}",
